...
<nav class="navbar navbar-dark navbar-expand-lg">
        <div class="container d-flex align-items-center">
            <div class="d-flex align-items-center">
             <a href="https://www.lexmoon.com/about.html" style="float: left;">
            <img src="https://i.ibb.co/YcnNWm7/20240917-222343-1.png" alt="Logo" style="height: 100px; margin: 10px 15px;">
        </a>
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto fs-5 text-white">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://www.lexmoon.com/about.html#about"><i class='bx bxs-user'></i>About</a></li>
                    <li class="nav-item"><a class="nav-link" href="https://www.lexmoon.com/about.html#contact"><i class='bx bxs-envelope'></i>Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
if submit_button:
    # If the file is not uploaded, show an error message
    if uploaded_file is None:
        st.error("Please upload a PDF file.")
    else:
        # Show a spinner while processing the file
        with st.spinner("Processing your file, please wait..."):
            # Simulate a delay for file processing (e.g., loading the file)
            import time
            time.sleep(25)  # Simulate processing time

            # Process the uploaded file (your logic here)
...
.stAppViewBlockContainer .block-container .st-emotion-cache-1jicfl2.ea3mdgi5 {
     ...
     .nav img {
        float: left;
        height: 4px; /* Adjust height to fit your nav bar */
...
current_year = datetime.now().year  # Use datetime to get the current year

# HTML for the footer
footer_html = f"""
    <footer class="footer">
        <div class="container text-center">
            <p>&copy; {current_year} lexmoon.pvtltd. All rights reserved.</p>
        </div>
    </footer>
"""
